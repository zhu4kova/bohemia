...
public class Modul_Person_zuweisen {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Modul_Person_zuweisen window = new Modul_Person_zuweisen();
	...
	private void initialize() {
		...
		JLabel lblLiteraturTitel = new JLabel("Modul zuweisen");
		lblLiteraturTitel.setFont(new Font("Tahoma", Font.BOLD, 24));
		frame.getContentPane().add(lblLiteraturTitel, "cell 0 0 2 1,grow");
		
		JLabel lblPerson = new JLabel("Person");
		frame.getContentPane().add(lblPerson, "cell 0 2,alignx left,aligny center");
		
		person = new JTextField();
		person.setText("");
		frame.getContentPane().add(person, "cell 1 2 2 1,growx,aligny center");
		...
		frame.getContentPane().add(btnModulZuweisen, "cell 4 2,growx,aligny center");
		
		JLabel lblModul = new JLabel("Modul");
		frame.getContentPane().add(lblModul, "cell 0 4,alignx left,aligny center");
		
		JComboBox modul = new JComboBox();
		frame.getContentPane().add(modul, "cell 1 4 3 1,growx");
